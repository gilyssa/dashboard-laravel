            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">Cidades inativas</h5>
                        </div>
                        <a href="{{ url('/city-management')}}" class="btn bg-gradient-primary btn-sm mb-0" type="button">Voltar</a>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach ($cities as $city)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span>
                                                <i class="cursor-pointer fas fa-undo text-secondary" onclick="recoverCity('{{ $city['id'] }}');" ></i>
                                            </span>
                                        </td>
                                        @endif
                                    </tr>
    ...
    function recoverCity(userId) {
        ...
        modal.addEventListener('show.bs.modal', function () {
            modalConfirmBtn.addEventListener('click', function () {
                ...
                fetch('/city-management/recover/' + userId, {
                    method: 'POST',
                    headers: {
