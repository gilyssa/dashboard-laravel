            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        @if ($userAccess === 'admin') 
                        <a href="{{ url('/enterprise-management-register')}}" class="btn bg-gradient-primary btn-sm mb-0 d-block d-sm-inline-block text-icon" type="button">
                            <span class="icon">
                              <i class="fas fa-plus text-white"></i>
                            </span>
                            <span class="text d-none d-sm-inline" style="width: 50%; height: 50%;">Cadastrar Empresa</span>
                          </a>
                          <a href="{{ url('/enterprise-management-removed')}}" class="btn bg-gradient-primary btn-sm mb-0 text-icon" type="button">
                            <span class="icon">
                              <i class="fas fa-trash text-white"></i>
                            </span>
                            <span class="text d-none d-sm-inline" style="width: 50%; height: 30%;">Empresas Removidas</span>
                          </a>             
                        @endif
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach ($enterprises as $enterprise)
                                    <tr>
                                        ...
                                        @if ($userAccess === 'admin') 
                                        <td class="text-center">
                                            <a class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit enterprise">
                                                <i class="cursor-pointer fas fa-building text-secondary" onclick="updateCity({{ $enterprise['id'] }});"></i>
                                            </a>
                                            <span>
                                                <i class="cursor-pointer fas fa-trash text-secondary" onclick="deleteCity({{ $enterprise['id'] }});" ></i>
                                            </span>
                                        </td>
                                        @endif
                                    </tr>
