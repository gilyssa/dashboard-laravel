            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        @if ($userAccess === 'admin') 
                        <a href="{{ url('/register')}}" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; Novo Usuário</a>
                        <a href="{{ url('/user-management-removed')}}" class="btn bg-gradient-primary btn-sm mb-0" type="button">Listar Removidos</a>
                        @endif
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="#" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit user">
                                                <i class="fas fa-user-edit text-secondary" onclick="updateUser({{ $user['id'] }});"></i>
                                            </a>
                                            <span>
                                                <i class="cursor-pointer fas fa-trash text-secondary" onclick="deleteUser({{ $user['id'] }});" ></i>
                                            </span>
                                        </td>
                                        @endif
                                    </tr>
