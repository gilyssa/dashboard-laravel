      ...
      <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
        <div class="card z-index-0">
          <div class="card-header text-center pt-4">
            <img src="{{ asset('assets\img\icone-faixa-preco.png') }}" width="90%" height="90%">
            <h5>Cadastro de nova faixa de preço</h5>
          </div>
          <div class="card-body">
            <form role="form text-left" method="POST" action="/priceband-management-new" id="pricebandForm">
              @csrf
              <div class="mb-3">
                <input type="text" class="form-control" placeholder="Value" id="value" name="value" aria-label="Value"
              ...
              <div class="text-center">
                ...
                <a href="/priceband-management" class="btn bg-gradient-dark w-100 my-4 mb-2">Voltar</a>
              </div>
            </form>
          </div>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="/priceband-management" type="button" class="btn btn-secondary">Voltar para tela anterior</a>
