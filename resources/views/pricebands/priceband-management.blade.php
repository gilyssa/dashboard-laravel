            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        @if ($userAccess === 'admin') 
                        <a href="{{ url('/priceband-management-register')}}" class="btn bg-gradient-primary btn-sm mb-0 d-block d-sm-inline-block text-icon" type="button">
                            <span class="icon">
                              <i class="fas fa-plus text-white"></i>
                            </span>
                            <span class="text d-none d-sm-inline" style="width: 50%; height: 50%;">Cadastrar Faixa de Preço</span>
                          </a>
                          <a href="{{ url('/priceband-management-removed')}}" class="btn bg-gradient-primary btn-sm mb-0 text-icon" type="button">
                            <span class="icon">
                              <i class="fas fa-trash text-white"></i>
                            </span>
                            <span class="text d-none d-sm-inline" style="width: 50%; height: 30%;">Faixas de Preço Removidas</span>
                          </a>             
                        @endif
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach ($pricebands as $priceband)
                                    <tr>
                                        ...
                                        @if ($userAccess === 'admin') 
                                        <td class="text-center">
                                            <a class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit priceband">
                                                <i class="cursor-pointer fas fa-building text-secondary" onclick="updateCity({{ $priceband['id'] }});"></i>
                                            </a>
                                            <span>
                                                <i class="cursor-pointer fas fa-trash text-secondary" onclick="deleteCity({{ $priceband['id'] }});" ></i>
                                            </span>
                                        </td>
                                        @endif
                                    </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteCityModalLabel">Confirmar desativação da Faixa de Preço</h5>
