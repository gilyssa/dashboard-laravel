...
@section('content')
                        ...
                        <div class="d-flex flex-row justify-content-between">
                            ...
                            @if ($userAccess === 'admin')
                                <a href="{{ url('/priceband-management-register') }}"
                                    ...
                                    <span class="text d-none d-sm-inline" style="width: 50%; height: 50%;">Cadastrar Faixa
                                        de Preço</span>
                                </a>
                                                ...
                                                <td class="text-center">
                                                    <a class="mx-3" data-bs-toggle="tooltip"
                                                        ...
                                                        <i class="cursor-pointer fas fa-dollar-sign text-secondary"
                                                            onclick="updatePriceBrand({{ $priceband['id'] }});"></i>
                                                    </a>
                                                    <span>
                                                        <i class="cursor-pointer fas fa-trash text-secondary"
                                                            onclick="deletePriceBrand({{ $priceband['id'] }});"></i>
                                                    </span>
                                                </td>
                                            @endif
                                        </tr>
    ...
    <div class="modal fade" id="deletePriceBrandModal" tabindex="-1" aria-labelledby="deletePriceBrandModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deletePriceBrandModalLabel">Confirmar desativação da Faixa de Preço</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="confirmDeletePriceBrand" class="btn btn-danger">Desativar</button>
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    <script>
        function deletePriceBrand(userId) {
            // Exibir o modal de confirmação
            var modal = document.getElementById('deletePriceBrandModal');
            var modalConfirmBtn = document.getElementById('confirmDeletePriceBrand');
        ...
        function updatePriceBrand(userId) {
